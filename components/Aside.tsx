...
<aside id="default-sidebar" className="w-[35%] md:w-[29%] lg:w-[20%] 2xl:w-[10%] "  >
  <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      
      <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          <li >
              <Link href={`/dashboard/InvoiceCreate`} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
